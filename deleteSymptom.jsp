...
<form name="f3" action="DeleteSymptoms" method="post"  onSubmit="return ValidateForm(f3)"><center>
<TABLE cellSpacing=1 cellPadding=1 width="90%" border=1 align="center">
  
  <TR><TD></TD>
    <TD><b>Symptom Id</b></TD>
    <TD><b>Symptom name</b></TD>
    
    
	<%
	  rs=st.executeQuery("SELECT * FROM SYMPTOMS order by sid");
	  int count=0;
	while(rs.next()){
		count++;
		%>
