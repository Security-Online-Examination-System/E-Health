...
public class DeleteSymptoms extends HttpServlet
{
	...
	if(s3.equals("Remove"))
		...
		int i=st.executeUpdate("delete from SYMPTOMS where sid = "+no);
		 if(i!=0) 
			 {
		 //pw.println("<html><h1>Disease deleted successfully </h1><center><a href="+"adminhome.html"+">back</a></center> <html>");
		 
		 pw.println("<html><body bgcolor=\"pink\"><center><br/><br/><br/><br/><br/><br/><br/><br/><h3><font color=\"red\"><h2>Symptom deleted successfully</h2></font></center></body></html>");
