...
%>
<center>
<h1><FONT color=mediumseagreen>All Diseases & Medicines
</FONT> </h1></center><hr color=blue><br>
<form align="left" name="f3" action="#" method="post" onsubmit="return checkinput()">
<table align="center"  bgcolor="#FFFFFF" cellpadding="5" cellspacing="5" width="725" border="0">
  ...
  <tr  bgcolor="#33CCFF"> 
    ...
    <td align="center"><b> Disease description</b></TD>
    <td align="center"><b>Medicine name</b></TD>
    <td align="center"><b> Medicine description</b></TD>

   
	<%System.out.println("++++++++++Reports++++++++++++++");
	  rs=st.executeQuery("Select distinct d.* ,m.mname, m.med_desc from disease d , medicine m where d.did=m.did order by d.did");
