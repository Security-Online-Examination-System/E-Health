...
<h1><FONT color=mediumseagreen>All Disease
        ...
        <form>
         <center> <table bgcolor="#FFFFFF" cellpadding="5" cellspacing="5" width="900" border="0">
            <tr  bgcolor="#33CCFF"> 
            <tr bgcolor="#E4E4F1"> 
              <td align="center"><font color="#110022"><strong>DID</strong></font></td>
...
%>
            <tr bgcolor="#FFFFCC"> 
              <td align="center"> <strong><font color="#6300C6"> <%=did%> </font></strong></td>
              <td align="center"><strong><font color="#6300C6"> <%=dname%> </font></strong></td>
              
              
               
               
              <td align="center"><a href="Updatedisease.jsp?did=<%=did%>"><strong><font color="#6300C6">modify</font></strong></a></td>
            </tr>
            <%
	   }
	   }
